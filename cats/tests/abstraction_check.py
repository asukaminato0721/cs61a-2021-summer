...
def swap_implementations(impl):
    ...
    old['game'] = impl.game, impl.word_at, impl.get_words, impl.get_times, impl.time

    # save our implementations
    new_game = game, word_at, get_words, get_times, time

    # replace impl's implementations with ours
    impl.game, impl.word_at, impl.get_words, impl.get_times, impl.time = game, word_at, get_words, get_times, time
