...
import log
from datamodel import Expression, Undefined
...
from scheme_exceptions import IrreversibleOperationError
...
class Draw(SingleOperandPrimitive):
    def execute_simple(self, operand: Expression) -> Expression:
        ...
        log.logger.raw_out("DRAW" +
                           json.dumps([log.logger.i,
                                       log.logger.heap.record(operand)]) + "\n")
        return Undefined
