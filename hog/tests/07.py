      ...
      'cases': [
        {
          ...
          >>> f1 = f0(12, 0)
          >>> f2 = f1(12, 10)
          Player 1 has reached a new maximum point gain. 10 point(s)!
          >>> f3 = f2(20, 10)
          >>> f4 = f3(22, 20)
          >>> f5 = f4(22, 35)
          Player 1 has reached a new maximum point gain. 15 point(s)!
          ...
          >>> f9 = f8(83, 32)
          >>> f10 = f9(38, 83)
          Player 1 has reached a new maximum point gain. 51 point(s)!
        ...
        },
        {
          ...
          Player 0 has reached a new maximum point gain. 5 point(s)!
          Player 1 has reached a new maximum point gain. 3 point(s)!
          """,
          'hidden': False,
          'locked': False
        }
